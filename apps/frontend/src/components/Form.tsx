    ...
    <div className="flex flex-col max-w-4xl  gap-2  items-center justify-center p-15  shadow-2xs rounded">
      ...
      <div className="flex flex-col gap-1.5">
        ...
        <input
          ...
          onChange={(e) => setFormDetail({...formDetail,password:e.target.value})}
          value={formDetail.password}
          required
        />
        <button className="bg-amber-400  hover:bg-amber-500 px-2 py-2 rounded-lg w-auto  text-lg mt-2" onClick={()=>onSubmit(formDetail)}>
