  ...
  var Splitter = /*#__PURE__*/React__namespace.memo(/*#__PURE__*/React__namespace.forwardRef(function (inProps, ref) {
    ...
    React__namespace.useEffect(function () {
      ...
      panelElements.map(function (panelElement, i) {
        ...
        if (panelElement.childNodes && utils.ObjectUtils.isNotEmpty(utils.DomHandler.find(panelElement, "[data-pc-name='splitter']")) && utils.ObjectUtils.isNotEmpty(utils.DomHandler.find(panelElement, "[data-pc-section='root']"))) {
