...
var Calendar = /*#__PURE__*/React__namespace.memo(/*#__PURE__*/React__namespace.forwardRef(function (inProps, ref) {
  ...
  var _useOverlayListener = hooks.useOverlayListener({
      ...
      listener: function listener(event, _ref) {
        ...
        if (valid) {
          ...
          } else if (context && context.hideOverlaysOnDocumentScrolling || PrimeReact__default["default"].hideOverlaysOnDocumentScrolling) {
            hide();
  ...
  var createAmPmPicker = function createAmPmPicker() {
    if (props.hourFormat === '12') {
      var currentTime = getCurrentDateTime();
      var _localeOptions0 = PrimeReact.localeOptions(props.locale),
  ...
  var createButtonBar = function createButtonBar() {
    if (props.showButtonBar) {
      var _localeOptions1 = PrimeReact.localeOptions(props.locale),
