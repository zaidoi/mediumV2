...
var OrganizationChartNode = /*#__PURE__*/React.memo(function (props) {
  ...
  var createChildNodes = function createChildNodes(row) {
    ...
    return rows.map(function (row, rowIndex) {
      ...
      return /*#__PURE__*/React.createElement("tr", _extends({}, nodesProps, {
        key: rowIndex
  ...
  var createLinesMiddle = function createLinesMiddle(row) {
    ...
    return rows.map(function (row, rowIndex) {
      ...
      return /*#__PURE__*/React.createElement("tr", _extends({}, linesProps, {
        key: rowIndex
        ...
        return /*#__PURE__*/React.createElement(React.Fragment, {
          key: index
        }, /*#__PURE__*/React.createElement("td", lineLeftProps, "\xA0"), /*#__PURE__*/React.createElement("td", lineRightProps, "\xA0"));
      }));
    });
  };
  var createLinesDown = function createLinesDown(row) {
    ...
    return rows.map(function (row, rowIndex) {
      ...
      return /*#__PURE__*/React.createElement("tr", _extends({}, linesProps, {
        key: rowIndex
      }), /*#__PURE__*/React.createElement("td", lineCellProps, /*#__PURE__*/React.createElement("div", lineDownProps)));
    });
  };
  ...
  return /*#__PURE__*/React.createElement("table", tableProps, /*#__PURE__*/React.createElement("tbody", null, nodeContent, createChildrenSection()));
});
